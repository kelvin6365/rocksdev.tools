  ...
  return (
    <Guide>
        ...
        <div className="space-y-2">
          ...
          <ul className="text-sm text-muted-foreground list-disc pl-4 space-y-1">
            {[
              ...
              t("guide.features.support-for-multiple-programming-languages"),
              t("guide.features.sql-schema-generation"),
              t("guide.features.copy-generated-sql-with-one-click"),
              t("guide.features.chat-history-saved-locally-in-your-browser"),
      ...
      <GuidePanel title={t("privacy.title")}>
        <div className="space-y-2">
          <h3 className="font-medium">{t("privacy.data_storage.title")}</h3>
